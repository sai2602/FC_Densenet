...
parser.add_argument("--ckpt", default="/data/Packaging_detection/Raw/Model_Logs_110/model_new.ckpt",
...
parser.add_argument("--output_folder", default="/mnt/daten/Packaging_detection/Raw/Train_Set/")
